								...
								<li class="dropdown">
									 <c:if test="${sessionScope.loginStudent != null }">
						                <div class="btn-group1" style="margin-top: 10px;">
											<a  href="self/${sessionScope.loginStudent.studentId }" class="btn btn-default btn-sm" id="self">个人信息</a>
											<a href="exit" class="btn btn-default btn-sm" >退出登录</a>
										</div>
									 </c:if>
									 <c:if test="${sessionScope.loginStudent == null }">
										<div class="btn-group" style="margin-top: 5px;">
											...
											<a href="admin/login.jsp" class="btn btn-default btn-sm" id="studentLogin">登录后台</a>
										</div>
									 </c:if>
								</li>
							</ul>
