...
<body>
	<div style="width: 100%; height: 98px; background-color: #BCC1C1;">
...
<!-- 			<div style="margin-top: 25px;width: 211px; height: 35px; line-height: 35px;text-align: center;"> -->
...
<!-- 		</div> -->
		<div id="loginTeacher" style="float:right; width: 190px; height:100%;line-height: 80px;">
			<c:if test="${sessionScope.loginTeacher != null }">
					<a  class="btn btn-info btn-sm" href="../teacher/${sessionScope.loginTeacher.teacherId }" target="right">修改信息</a>
				    <a class="btn btn-info btn-sm" href="../exitTeacher" target="_parent">退出登录</a>
			</c:if>
			<c:if test="${sessionScope.loginTeacher == null }">
