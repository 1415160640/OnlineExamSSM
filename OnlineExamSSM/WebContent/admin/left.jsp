...
<body id="bg">
	...
	<div class="container">
		<div class="leftsidebar_box">
			...
			<dl class="system_log">
				<dt onClick="changeImage()">基本设置<img src="${path }/images/left/select_xl01.png" /></dt>
			 ...
			 <c:if test="${sessionScope.loginTeacher.adminPower != 0 }">
			 <dl class="custom">
			...
			<dl class="app">
				<dt onClick="changeImage()">试题信息管理<img src="${path }/images/left/select_xl01.png" /></dt>
			...
			<dl class="syetem_management">
				<dt>考试信息管理<img src="${path }/images/left/select_xl01.png" /></dt>
				<dd class="first_dd"><a href="../examPlans" target="right" id="9" class="handle-view">&emsp;待考信息&emsp;&emsp;&emsp;</a></dd>
				<dd class="first_dd"><a href="../historys" target="right" id="10" class="handle-view">&emsp;考试记录&emsp;&emsp;&emsp;</a></dd>
			</dl>
